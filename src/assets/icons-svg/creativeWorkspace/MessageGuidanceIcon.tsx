import type { Message } from "@components/login/LoginPage.styles";
...
const MessageGuidanceIcon: React.FC<IconProps> = ({
  size = 12,
  color = "white",
  ...props
}) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_6399_109730)">
        <path
...
export default MessageGuidanceIcon;
