              ...
              return (
                <Box key={field.id}>
                  ...
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <Stack spacing={2}>
                      <Controller
                        name={`componentsSchema.schedules.${index}.startDateTime`}
                        control={control}
                        render={({ field }) => (
                          <DateTimePicker
                      ...
                      <Controller
                        name={`componentsSchema.schedules.${index}.endDateTime`}
                        control={control}
                        render={({ field }) => {
