              ...
              helperText={
                  ...
                  >
                    <Typography
                      component="span"
                      color={
                        (seoMetaDescription?.length ?? 0) >= 160 ? "error" : "text.secondary"
                      }
                    >
                      {seoMetaDescription?.length ?? 0} characters
                    </Typography>
